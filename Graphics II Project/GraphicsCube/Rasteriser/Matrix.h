...
public:
	...
	static Matrix CameraTranslation(float x, float y, float z);
	static Matrix CameraXRotation(float angle);
	static Matrix CameraYRotation(float angle);
	static Matrix CameraZRotation(float angle);
	static Matrix PerspectiveMatrix(float d, float aspectRatio);
	static Matrix ViewMatrix(float d, float width, float height);
	static Matrix Position(float positionX, float positionY, float positionZ);
